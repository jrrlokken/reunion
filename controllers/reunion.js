...
exports.getUpcoming = (req, res, next) => {
  res.render('reunion/upcoming', {
    ...
    reunion: {
      ...
      description: `Here will be a description and details for the upcoming reunion.
         Since we are not sure when it will take place, I'm just calling it the 2023 reunion for now 😉`,
    },
  });
};
